	...
	<footer>
		<div class="foot_area box_inner">
			...
			<ul class="snslink clear">
				<li><a href="https://section.blog.naver.com/BlogHome.nhn?directoryNo=0&currentPage=1&groupId=0">blog</a></li>
				<li><a href="https://www.facebook.com/">facebook</a></li>
				<li><a href="https://www.instagram.com/?hl=ko">instargram</a></li>
			</ul>
		</div>
	</footer>
